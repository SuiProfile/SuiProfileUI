          ...
          <div className="bg-white dark:bg-[#1A1A1A] rounded-3xl border border-gray-200 dark:border-gray-800 p-8 max-w-lg w-full">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6 text-sm">
              {containerId === "statistics-container" 
                ? "İstatistiklerinizin o anki halini NFT olarak mint edin"
                : "Dashboard'unuzun o anki halini NFT olarak mint edin"
              }
            </p>
            ...
            {!dashboardCollectionId && (
              <div className="mb-4 p-3 bg-yellow-100 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-lg">
                <p className="text-yellow-800 dark:text-yellow-200 text-sm">
                  ⚠️ Dashboard collection ID bulunamadı. Move contract deploy edilmeli ve environment variable eklenmeli.
                </p>
              </div>
            )}
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="My Dashboard - Q4 2024"
                  value={title}
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800">
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2">SNAPSHOT DETAYLARI</p>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-400">Toplam Tıklama:</span>
                  <span className="font-bold text-gray-900 dark:text-white">{stats.totalClicks}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-400">Toplam Link:</span>
